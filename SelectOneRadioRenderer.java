 ...
 * extend org.primefaces.component.selectoneradio.SelectOneRadioRenderer, and do some overrides
 */
public class SelectOneRadioRenderer extends  InputRenderer{ //InputRenderer org.primefaces.component.selectoneradio.SelectOneRadioRenderer
...
//    @Override
    ...
    protected void encodeScript(FacesContext context, SelectOneRadio radio) throws IOException {
      ...
      writer.writeAttribute("type", "text/javascript", null);
        ...
        //############# PF3.0M3 has the method, but 3.0RC2 does not
    ...
    protected void encodeOption(FacesContext context, SelectOneRadio radio, String itemLabel, Object itemValue) throws IOException {
        ...
        //2012-12-11: can not find method def: getConverter. set to null. this object was commented out in jsf.web
        //javax.faces.component.ValueHolder
        
        Converter converter =   null; //getConverter(context, radio);
